...
var md5 = function() {
	...
	function r(n, r, t, e, o, u) {
		return f(function(n, r) {
			return n << r | n >>> 32 - r
		}(f(f(r, n), f(e, u)), o), t)
	}

	function t(n, t, e, o, u, f, i) {
		return r(t & e | ~t & o, n, t, u, f, i)
	}

	function e(n, t, e, o, u, f, i) {
		return r(t & o | e & ~o, n, t, u, f, i)
	}

	function o(n, t, e, o, u, f, i) {
		return r(t ^ e ^ o, n, t, u, f, i)
	}

	function u(n, t, e, o, u, f, i) {
		return r(e ^ (t | ~o), n, t, u, f, i)
	}
	...
	return function(r) {
		r instanceof Uint8Array || (r = (new TextEncoder).encode("string" == typeof r ? r : JSON.stringify(r)));
		for (var t = [], e = new Uint8Array(r), o = 0, u = e.byteLength; o < u; o++) t.push(String.fromCharCode(e[o]));
		return n(t.join(""))
	}
}();
